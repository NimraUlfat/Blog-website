      ...
      <div className="p-4 md:w-1/3">
        <div className="bounce-in-right sm:jello-horizontal hover:bg-slate-300 shadow-xl m-3 h-full border-2 border-gray-800 rounded-lg border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-800 font-bold leading-relaxed mb-3">Pakistani cuisine is a flavorful fusion of spices, herbs, and diverse cooking techniques, reflecting the country rich cultural heritage.</p>
            <div className="flex items-center flex-wrap ">
            <Link href={"/Cuisine"}>
              <li className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="p-4 md:w-1/3">
        <div className="bounce-in-right sm:jello-horizontal hover:bg-slate-300 shadow-xl m-3 h-full border-2 border-gray-800 rounded-lg border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-800 font-bold leading-relaxed mb-3">Pakistan music and dance reflect its rich cultural heritage and diversity. Traditional music includes genres like Qawwali, Sufi shrines, and folk music.</p>
            <div className="flex items-center flex-wrap">
            <Link href={"/music"}>
              <li className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
